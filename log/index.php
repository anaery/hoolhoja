												...
												<?php 
													...
													try{	
														...
														foreach ($db->query($sql) as $row) {
															?>
															<tr>
																<?php $time = strtotime($row['logData']); $myFormatDateForView = date("d/m/Y", $time); ?>
																...
																<td style="text-align:center;"><?php echo $row['logRegistro']; ?></td>
																<td style="text-align:center;"><?php echo $row['logNome']; ?></td>
																<td style="text-align:center;"><?php echo $row['logMatricula']; ?></td>
																<td style="text-align:center;"><?php echo $row['logContagem']; ?></td>
															</tr>
															<?php 
														}
													}
